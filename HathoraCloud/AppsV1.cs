...
namespace HathoraCloud
{
    ...
    public interface IAppsV1
    {
        ...
        /// </remarks>
        /// </summary>
        Task<CreateAppV1DeprecatedResponse> CreateAppV1DeprecatedAsync(CreateAppConfig request);
    ...
    public class AppsV1: IAppsV1
    {
        ...
        public async Task<CreateAppV1DeprecatedResponse> CreateAppV1DeprecatedAsync(CreateAppConfig request)
        {
        ...
        public async Task<GetAppsV1DeprecatedResponse> GetAppsV1DeprecatedAsync()
        {
            ...
            else if (new List<int>{401, 408, 429}.Contains(httpCode))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {                    
                    var obj = JsonConvert.DeserializeObject<ApiError>(httpResponse.downloadHandler.text, new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = Utilities.GetDefaultJsonDeserializers() });
