...
namespace HathoraCloud
{
    ...
    public interface IBuildsV2
    {
        ...
        /// </summary>
        Task<CreateBuildWithUploadUrlResponse> CreateBuildWithUploadUrlAsync(CreateBuildWithUploadUrlRequest request);
    ...
    public class BuildsV2: IBuildsV2
    {
        ...
        public async Task<CreateBuildWithUploadUrlResponse> CreateBuildWithUploadUrlAsync(CreateBuildWithUploadUrlRequest request)
        {
            if (request == null)
            {
                request = new CreateBuildWithUploadUrlRequest();
            }
            request.AppId ??= SDKConfiguration.AppId;
            ...
            int httpCode = errorCode ?? (int)httpResponse.responseCode;
            var response = new CreateBuildWithUploadUrlResponse
            {
                StatusCode = httpCode,
                ContentType = contentType,
                RawResponse = httpResponse
