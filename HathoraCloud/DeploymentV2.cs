...
namespace HathoraCloud
{
    ...
    /// </summary>
    public interface IDeploymentV2
    {
    ...
    /// Operations that allow you configure and manage an application&apos;s <a href="https://hathora.dev/docs/concepts/hathora-entities#build">build</a> at runtime.
    /// </summary>
    public class DeploymentV2: IDeploymentV2
    {
        ...
        public DeploymentV2(ISpeakeasyHttpClient defaultClient, Func<Security>? securitySource, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<CreateDeploymentResponse> CreateDeploymentAsync(CreateDeploymentRequest request)
        {
            ...
            if (httpCode == 201)
            {
                ...
                {                    
                    var obj = JsonConvert.DeserializeObject<HathoraCloud.Models.Shared.DeploymentV2>(httpResponse.downloadHandler.text, new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = Utilities.GetDefaultJsonDeserializers() });
        ...
        public async Task<GetDeploymentsResponse> GetDeploymentsAsync(GetDeploymentsRequest request)
        {
            ...
            if (httpCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {                    
                    var obj = JsonConvert.DeserializeObject<List<HathoraCloud.Models.Shared.DeploymentV2>>(httpResponse.downloadHandler.text, new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = Utilities.GetDefaultJsonDeserializers() });
