...
using(var res = await sdk.DeploymentsV2.CreateDeploymentAsync(req))
{
    // handle response
}
...
using(var res = await sdk.DeploymentsV2.GetDeploymentInfoAsync(req))
{
    // handle response
}
...
using(var res = await sdk.DeploymentsV2.GetDeploymentsAsync(req))
{
    // handle response
}
...
using(var res = await sdk.DeploymentsV2.GetLatestDeploymentAsync(req))
{
    // handle response
}
