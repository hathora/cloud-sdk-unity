    ...
    public class AppV1: IAppV1
    {
        ...
        public async Task<CreateAppResponse> CreateAppAsync(AppConfig request)
        {
            ...
            if((response.StatusCode == 201))
            {
                ...
                {
                    response.Application = JsonConvert.DeserializeObject<HathoraUnitySDK.Models.Shared.Application>(httpResponse.downloadHandler.text, new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new DateOnlyConverter(), new EnumSerializer() }});
                }
