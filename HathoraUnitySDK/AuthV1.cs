...
namespace HathoraUnitySDK
{
    ...
    public interface IAuthV1
    {
        ...
        /// </summary>
        Task<LoginGoogleResponse> LoginGoogleAsync(HathoraUnitySDK.Models.Operations.LoginGoogleRequest request);

        /// <summary>
        /// Returns a unique player token with a specified nickname for a user.
        /// </summary>
        Task<LoginNicknameResponse> LoginNicknameAsync(HathoraUnitySDK.Models.Operations.LoginNicknameRequest request);
    }
    ...
    public class AuthV1: IAuthV1
    {
        ...
        public async Task<LoginGoogleResponse> LoginGoogleAsync(HathoraUnitySDK.Models.Operations.LoginGoogleRequest request)
        {
            request.AppId ??= Config.AppId;
            string baseUrl = _serverUrl;
            if (baseUrl.EndsWith("/"))
        ...
        public async Task<LoginNicknameResponse> LoginNicknameAsync(HathoraUnitySDK.Models.Operations.LoginNicknameRequest request)
        {
            request.AppId ??= Config.AppId;
            string baseUrl = _serverUrl;
            if (baseUrl.EndsWith("/"))
