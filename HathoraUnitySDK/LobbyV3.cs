...
namespace HathoraUnitySDK
{
    ...
    public class LobbyV3: ILobbyV3
    {
        ...
        public LobbyV3(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<CreateLobbyResponse> CreateLobbyAsync(CreateLobbySecurity security, CreateLobbyRequest request)
        {
            ...
            if((response.StatusCode == 201))
            {
                ...
                {
                    response.LobbyV3 = JsonConvert.DeserializeObject<HathoraUnitySDK.Models.Shared.LobbyV3>(httpResponse.downloadHandler.text, new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new DateOnlyConverter(), new EnumSerializer() }});
                }
